...
abstract class PayjoinCoreApiImplPlatform extends BaseApiImpl<PayjoinCoreWire> {
  ...
  List<dynamic> cst_encode_headers(Headers raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [cst_encode_Map_String_String(raw.map)];
  }
  ...
  @protected
  List<dynamic>
      cst_encode_record_record_url_list_prim_u_8_strict_client_response(
          ((Url, Uint8List), ClientResponse) raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_record_url_list_prim_u_8_strict(raw.$1),
      cst_encode_client_response(raw.$2)
    ];
  }
  ...
  @protected
  List<dynamic> cst_encode_record_url_list_prim_u_8_strict(
      (Url, Uint8List) raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [cst_encode_url(raw.$1), cst_encode_list_prim_u_8_strict(raw.$2)];
  }
  ...
  List<dynamic> cst_encode_request_context_v_1(RequestContextV1 raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_record_url_list_prim_u_8_strict(raw.request),
...
class PayjoinCoreWire implements BaseWire {
  ...
  void wire_maybe_inputs_owned_check_inputs_not_owned(
      ...
      wasmModule.wire_maybe_inputs_owned_check_inputs_not_owned(
          port_, ptr, is_owned);

  void wire_maybe_inputs_seen_check_no_inputs_seen_before(
          NativePortType port_, List<dynamic> ptr, PlatformPointer is_known) =>
      wasmModule.wire_maybe_inputs_seen_check_no_inputs_seen_before(
          port_, ptr, is_known);

  void wire_maybe_mixed_input_scripts_check_no_mixed_input_scripts(
          NativePortType port_, List<dynamic> ptr) =>
      wasmModule.wire_maybe_mixed_input_scripts_check_no_mixed_input_scripts(
          port_, ptr);

  void wire_outputs_unknown_identify_receiver_outputs(NativePortType port_,
          List<dynamic> ptr, PlatformPointer is_receiver_output) =>
      wasmModule.wire_outputs_unknown_identify_receiver_outputs(
          port_, ptr, is_receiver_output);

  void wire_payjoin_proposal_is_output_substitution_disabled(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_payjoin_proposal_is_output_substitution_disabled(
          port_, that);

  void wire_payjoin_proposal_owned_vouts(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_payjoin_proposal_owned_vouts(port_, that);

  void wire_payjoin_proposal_psbt(NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_payjoin_proposal_psbt(port_, that);

  void wire_payjoin_proposal_utxos_to_be_locked(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_payjoin_proposal_utxos_to_be_locked(port_, that);
  ...
  void wire_provisional_proposal_contribute_non_witness_input(
      ...
      wasmModule.wire_provisional_proposal_contribute_non_witness_input(
          port_, that, tx, outpoint);

  void wire_provisional_proposal_contribute_witness_input(NativePortType port_,
          List<dynamic> that, List<dynamic> txo, List<dynamic> outpoint) =>
      wasmModule.wire_provisional_proposal_contribute_witness_input(
  ...
  void wire_provisional_proposal_finalize_proposal(
      ...
      wasmModule.wire_provisional_proposal_finalize_proposal(
          port_, ptr, process_psbt, min_feerate_sat_per_vb);

  void wire_provisional_proposal_substitute_output_address(
          NativePortType port_, List<dynamic> that, String address) =>
      wasmModule.wire_provisional_proposal_substitute_output_address(
          port_, that, address);

  void wire_provisional_proposal_try_preserving_privacy(NativePortType port_,
          List<dynamic> that, List<dynamic> candidate_inputs) =>
      wasmModule.wire_provisional_proposal_try_preserving_privacy(
          port_, that, candidate_inputs);

  void wire_unchecked_proposal_assume_interactive_receiver(
          NativePortType port_, List<dynamic> ptr) =>
      wasmModule.wire_unchecked_proposal_assume_interactive_receiver(
          port_, ptr);
  ...
  void wire_unchecked_proposal_check_broadcast_suitability(
      ...
      wasmModule.wire_unchecked_proposal_check_broadcast_suitability(
          port_, ptr, min_fee_rate, can_broadcast);

  void wire_unchecked_proposal_extract_tx_to_schedule_broadcast(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_unchecked_proposal_extract_tx_to_schedule_broadcast(
          port_, that);

  void wire_unchecked_proposal_from_request(NativePortType port_,
          List<int> body, String query, List<dynamic> headers) =>
      wasmModule.wire_unchecked_proposal_from_request(
  ...
  void wire_v_2_maybe_inputs_owned_check_inputs_not_owned(
      ...
      wasmModule.wire_v_2_maybe_inputs_owned_check_inputs_not_owned(
          port_, that, is_owned);
  ...
  void wire_v_2_maybe_inputs_seen_check_no_inputs_seen_before(
      ...
      wasmModule.wire_v_2_maybe_inputs_seen_check_no_inputs_seen_before(
          port_, that, is_known);
  ...
  void wire_v_2_outputs_unknown_identify_receiver_outputs(NativePortType port_,
  ...
  void wire_v_2_payjoin_proposal_deserialize_res(NativePortType port_,
          List<dynamic> that, List<int> res, List<dynamic> ohttp_context) =>
      wasmModule.wire_v_2_payjoin_proposal_deserialize_res(
  ...
  void wire_v_2_payjoin_proposal_owned_vouts(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_v_2_payjoin_proposal_owned_vouts(port_, that);

  void wire_v_2_payjoin_proposal_psbt(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_v_2_payjoin_proposal_psbt(port_, that);

  void wire_v_2_payjoin_proposal_utxos_to_be_locked(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_v_2_payjoin_proposal_utxos_to_be_locked(port_, that);
  ...
  void wire_v_2_provisional_proposal_contribute_non_witness_input(
          ...
          List<int> tx,
          List<dynamic> outpoint) =>
      wasmModule.wire_v_2_provisional_proposal_contribute_non_witness_input(
          port_, that, tx, outpoint);
  ...
  void wire_v_2_provisional_proposal_contribute_witness_input(
          ...
          List<dynamic> txo,
          List<dynamic> outpoint) =>
      wasmModule.wire_v_2_provisional_proposal_contribute_witness_input(
          port_, that, txo, outpoint);
  ...
  void wire_v_2_provisional_proposal_finalize_proposal(
          ...
          PlatformPointer process_psbt,
          Object? min_feerate_sat_per_vb) =>
      wasmModule.wire_v_2_provisional_proposal_finalize_proposal(
          port_, that, process_psbt, min_feerate_sat_per_vb);

  void wire_v_2_provisional_proposal_substitute_output_address(
          NativePortType port_, List<dynamic> that, String address) =>
      wasmModule.wire_v_2_provisional_proposal_substitute_output_address(
          port_, that, address);

  void wire_v_2_provisional_proposal_try_preserving_privacy(
          NativePortType port_,
          List<dynamic> that,
          List<dynamic> candidate_inputs) =>
      wasmModule.wire_v_2_provisional_proposal_try_preserving_privacy(
          port_, that, candidate_inputs);

  void wire_v_2_unchecked_proposal_assume_interactive_receiver(
          NativePortType port_, List<dynamic> that) =>
      wasmModule.wire_v_2_unchecked_proposal_assume_interactive_receiver(
          port_, that);
  ...
  void wire_request_builder_from_psbt_and_uri(
      ...
      wasmModule.wire_request_builder_from_psbt_and_uri(
...
class PayjoinCoreWasmModule implements WasmModule {
  ...
  external void wire_maybe_inputs_seen_check_no_inputs_seen_before(
      NativePortType port_, List<dynamic> ptr, PlatformPointer is_known);

  external void wire_maybe_mixed_input_scripts_check_no_mixed_input_scripts(
      NativePortType port_, List<dynamic> ptr);

  external void wire_outputs_unknown_identify_receiver_outputs(
      NativePortType port_,
      List<dynamic> ptr,
      PlatformPointer is_receiver_output);

  external void wire_payjoin_proposal_is_output_substitution_disabled(
      NativePortType port_, List<dynamic> that);

  external void wire_payjoin_proposal_owned_vouts(
      NativePortType port_, List<dynamic> that);

  external void wire_payjoin_proposal_psbt(
      NativePortType port_, List<dynamic> that);

  external void wire_payjoin_proposal_utxos_to_be_locked(
      NativePortType port_, List<dynamic> that);

  external void wire_provisional_proposal_contribute_non_witness_input(
      NativePortType port_,
      List<dynamic> that,
      List<int> tx,
      List<dynamic> outpoint);

  external void wire_provisional_proposal_contribute_witness_input(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> txo,
      List<dynamic> outpoint);

  external void wire_provisional_proposal_finalize_proposal(
      NativePortType port_,
      List<dynamic> ptr,
      PlatformPointer process_psbt,
      Object? min_feerate_sat_per_vb);

  external void wire_provisional_proposal_substitute_output_address(
      NativePortType port_, List<dynamic> that, String address);

  external void wire_provisional_proposal_try_preserving_privacy(
      NativePortType port_, List<dynamic> that, List<dynamic> candidate_inputs);

  external void wire_unchecked_proposal_assume_interactive_receiver(
      NativePortType port_, List<dynamic> ptr);

  external void wire_unchecked_proposal_check_broadcast_suitability(
      NativePortType port_,
      List<dynamic> ptr,
      Object? min_fee_rate,
      PlatformPointer can_broadcast);

  external void wire_unchecked_proposal_extract_tx_to_schedule_broadcast(
      NativePortType port_, List<dynamic> that);

  external void wire_unchecked_proposal_from_request(NativePortType port_,
      List<int> body, String query, List<dynamic> headers);

  external void wire_v_2_maybe_inputs_owned_check_inputs_not_owned(
      NativePortType port_, List<dynamic> that, PlatformPointer is_owned);

  external void wire_v_2_maybe_inputs_seen_check_no_inputs_seen_before(
      NativePortType port_, List<dynamic> that, PlatformPointer is_known);

  external void wire_v_2_maybe_mixed_input_scripts_check_no_mixed_input_scripts(
      NativePortType port_, List<dynamic> that);

  external void wire_v_2_outputs_unknown_identify_receiver_outputs(
      NativePortType port_,
      List<dynamic> that,
      PlatformPointer is_receiver_output);

  external void wire_v_2_payjoin_proposal_deserialize_res(NativePortType port_,
      List<dynamic> that, List<int> res, List<dynamic> ohttp_context);

  external void wire_v_2_payjoin_proposal_extract_v1_req(
      NativePortType port_, List<dynamic> that);
  ...
  external void wire_v_2_payjoin_proposal_owned_vouts(
      NativePortType port_, List<dynamic> that);

  external void wire_v_2_payjoin_proposal_psbt(
      NativePortType port_, List<dynamic> that);

  external void wire_v_2_payjoin_proposal_utxos_to_be_locked(
      NativePortType port_, List<dynamic> that);

  external void wire_v_2_provisional_proposal_contribute_non_witness_input(
      NativePortType port_,
      List<dynamic> that,
      List<int> tx,
      List<dynamic> outpoint);

  external void wire_v_2_provisional_proposal_contribute_witness_input(
      NativePortType port_,
      List<dynamic> that,
      List<dynamic> txo,
      List<dynamic> outpoint);

  external void wire_v_2_provisional_proposal_finalize_proposal(
      NativePortType port_,
      List<dynamic> that,
      PlatformPointer process_psbt,
      Object? min_feerate_sat_per_vb);
  ...
  external void wire_v_2_provisional_proposal_try_preserving_privacy(
      NativePortType port_, List<dynamic> that, List<dynamic> candidate_inputs);

  external void wire_v_2_unchecked_proposal_assume_interactive_receiver(
      NativePortType port_, List<dynamic> that);

  external void wire_v_2_unchecked_proposal_check_broadcast_suitability(
      NativePortType port_,
      List<dynamic> that,
      Object? min_fee_rate,
      PlatformPointer can_broadcast);

  external void wire_v_2_unchecked_proposal_extract_tx_to_schedule_broadcast(
      NativePortType port_, List<dynamic> that);

  external void wire_context_v_1_process_response(
      NativePortType port_, List<dynamic> that, List<int> response);

  external void wire_context_v_2_process_response(
      NativePortType port_, List<dynamic> that, List<int> response);

  external void wire_request_builder_always_disable_output_substitution(
      NativePortType port_, List<dynamic> that, bool disable);

  external void wire_request_builder_build_non_incentivizing(
      NativePortType port_, List<dynamic> that);

  external void wire_request_builder_build_recommended(
      NativePortType port_, List<dynamic> that, Object min_fee_rate);

  external void wire_request_builder_build_with_additional_fee(
      NativePortType port_,
      List<dynamic> that,
      Object max_fee_contribution,
      int? change_index,
  ...
  external void wire_request_builder_from_psbt_and_uri(
      NativePortType port_, String psbt_base64, List<dynamic> uri);
