...
impl CstDecode<Arc<V2MaybeInputsOwned>> for usize {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> Arc<V2MaybeInputsOwned> {
        CstDecode::<
            RustOpaqueNom<
...
impl CstDecode<Arc<V2MaybeInputsSeen>> for usize {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> Arc<V2MaybeInputsSeen> {
        CstDecode::<
            RustOpaqueNom<
...
impl CstDecode<std::collections::HashMap<u64, crate::api::receive::OutPoint>>
    for *mut wire_cst_list_record_u_64_out_point
{
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> std::collections::HashMap<u64, crate::api::receive::OutPoint> {
        let vec: Vec<(u64, crate::api::receive::OutPoint)> = self.cst_decode();
        vec.into_iter().collect()
    }
}
    ...
    > for usize
{
    ...
    fn cst_decode(
        self,
    ) -> RustOpaqueNom<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc<V2MaybeInputsSeen>>>
    {
        unsafe { decode_rust_opaque_nom(self as _) }
    }
}
...
impl CstDecode<crate::api::receive::OutPoint> for *mut wire_cst_out_point {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::receive::OutPoint {
        let wrap = unsafe { flutter_rust_bridge::for_generated::box_from_leak_ptr(self) };
        CstDecode::<crate::api::receive::OutPoint>::cst_decode(*wrap).into()
    }
}
...
impl CstDecode<crate::api::receive::TxOut> for *mut wire_cst_tx_out {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::receive::TxOut {
        let wrap = unsafe { flutter_rust_bridge::for_generated::box_from_leak_ptr(self) };
        CstDecode::<crate::api::receive::TxOut>::cst_decode(*wrap).into()
    }
}
...
impl CstDecode<Vec<crate::api::receive::OutPoint>> for *mut wire_cst_list_out_point {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> Vec<crate::api::receive::OutPoint> {
        let vec = unsafe {
...
impl CstDecode<Vec<(u64, crate::api::receive::OutPoint)>>
    for *mut wire_cst_list_record_u_64_out_point
{
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> Vec<(u64, crate::api::receive::OutPoint)> {
        let vec = unsafe {
            let wrap = flutter_rust_bridge::for_generated::box_from_leak_ptr(self);
            flutter_rust_bridge::for_generated::vec_from_leak_ptr(wrap.ptr, wrap.len)
        };
...
impl CstDecode<crate::api::receive::OutPoint> for wire_cst_out_point {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::receive::OutPoint {
        crate::api::receive::OutPoint {
...
impl CstDecode<(u64, crate::api::receive::OutPoint)> for wire_cst_record_u_64_out_point {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> (u64, crate::api::receive::OutPoint) {
        (self.field0.cst_decode(), self.field1.cst_decode())
    }
}
...
impl CstDecode<crate::api::receive::RequestResponse> for wire_cst_request_response {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::receive::RequestResponse {
        crate::api::receive::RequestResponse {
            request: self.request.cst_decode(),
            client_response: self.client_response.cst_decode(),
        }
    }
}
impl CstDecode<crate::api::receive::TxOut> for wire_cst_tx_out {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::receive::TxOut {
        crate::api::receive::TxOut {
...
impl Default for wire_cst_request_response {
    fn default() -> Self {
        Self::new_with_null_ptr()
    }
}
...
#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_MaybeInputsOwned_check_inputs_not_owned(
    port_: i64,
    that: *mut wire_cst_maybe_inputs_owned,
    is_owned: *const std::ffi::c_void,
) {
    wire_MaybeInputsOwned_check_inputs_not_owned_impl(port_, that, is_owned)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_MaybeInputsSeen_check_no_inputs_seen_before(
    port_: i64,
    that: *mut wire_cst_maybe_inputs_seen,
    is_known: *const std::ffi::c_void,
) {
    wire_MaybeInputsSeen_check_no_inputs_seen_before_impl(port_, that, is_known)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_MaybeMixedInputScripts_check_no_mixed_input_scripts(
    port_: i64,
    that: *mut wire_cst_maybe_mixed_input_scripts,
) {
    wire_MaybeMixedInputScripts_check_no_mixed_input_scripts_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_OutputsUnknown_identify_receiver_outputs(
    port_: i64,
    that: *mut wire_cst_outputs_unknown,
    is_receiver_output: *const std::ffi::c_void,
) {
    wire_OutputsUnknown_identify_receiver_outputs_impl(port_, that, is_receiver_output)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_PayjoinProposal_is_output_substitution_disabled(
    port_: i64,
    that: *mut wire_cst_payjoin_proposal,
) {
    wire_PayjoinProposal_is_output_substitution_disabled_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_PayjoinProposal_owned_vouts(
    port_: i64,
    that: *mut wire_cst_payjoin_proposal,
) {
    wire_PayjoinProposal_owned_vouts_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_PayjoinProposal_psbt(
    port_: i64,
    that: *mut wire_cst_payjoin_proposal,
) {
    wire_PayjoinProposal_psbt_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_PayjoinProposal_utxos_to_be_locked(
    port_: i64,
    that: *mut wire_cst_payjoin_proposal,
) {
    wire_PayjoinProposal_utxos_to_be_locked_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_ProvisionalProposal_contribute_non_witness_input(
    port_: i64,
    that: *mut wire_cst_provisional_proposal,
    tx: *mut wire_cst_list_prim_u_8_loose,
    outpoint: *mut wire_cst_out_point,
) {
    wire_ProvisionalProposal_contribute_non_witness_input_impl(port_, that, tx, outpoint)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_ProvisionalProposal_contribute_witness_input(
    port_: i64,
    that: *mut wire_cst_provisional_proposal,
    txo: *mut wire_cst_tx_out,
    outpoint: *mut wire_cst_out_point,
) {
    wire_ProvisionalProposal_contribute_witness_input_impl(port_, that, txo, outpoint)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_ProvisionalProposal_finalize_proposal(
    port_: i64,
    that: *mut wire_cst_provisional_proposal,
    process_psbt: *const std::ffi::c_void,
    min_feerate_sat_per_vb: *mut u64,
) {
    wire_ProvisionalProposal_finalize_proposal_impl(
        port_,
        that,
        process_psbt,
...
#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_ProvisionalProposal_substitute_output_address(
    port_: i64,
    that: *mut wire_cst_provisional_proposal,
    address: *mut wire_cst_list_prim_u_8_strict,
) {
    wire_ProvisionalProposal_substitute_output_address_impl(port_, that, address)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_ProvisionalProposal_try_preserving_privacy(
    port_: i64,
    that: *mut wire_cst_provisional_proposal,
    candidate_inputs: *mut wire_cst_list_record_u_64_out_point,
) {
    wire_ProvisionalProposal_try_preserving_privacy_impl(port_, that, candidate_inputs)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_UncheckedProposal_assume_interactive_receiver(
    port_: i64,
    that: *mut wire_cst_unchecked_proposal,
) {
    wire_UncheckedProposal_assume_interactive_receiver_impl(port_, that)
}
...
#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2MaybeInputsOwned_check_inputs_not_owned(
    port_: i64,
    that: *mut wire_cst_v_2_maybe_inputs_owned,
    is_owned: *const std::ffi::c_void,
) {
    wire_V2MaybeInputsOwned_check_inputs_not_owned_impl(port_, that, is_owned)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2MaybeInputsSeen_check_no_inputs_seen_before(
    port_: i64,
    that: *mut wire_cst_v_2_maybe_inputs_seen,
    is_known: *const std::ffi::c_void,
) {
    wire_V2MaybeInputsSeen_check_no_inputs_seen_before_impl(port_, that, is_known)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2MaybeMixedInputScripts_check_no_mixed_input_scripts(
    port_: i64,
    that: *mut wire_cst_v_2_maybe_mixed_input_scripts,
) {
    wire_V2MaybeMixedInputScripts_check_no_mixed_input_scripts_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2OutputsUnknown_identify_receiver_outputs(
    port_: i64,
    that: *mut wire_cst_v_2_outputs_unknown,
    is_receiver_output: *const std::ffi::c_void,
) {
    wire_V2OutputsUnknown_identify_receiver_outputs_impl(port_, that, is_receiver_output)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_deserialize_res(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
    res: *mut wire_cst_list_prim_u_8_loose,
    ohttp_context: *mut wire_cst_client_response,
) {
    wire_V2PayjoinProposal_deserialize_res_impl(port_, that, res, ohttp_context)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_extract_v1_req(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_extract_v1_req_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_extract_v2_req(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_extract_v2_req_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_is_output_substitution_disabled(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_is_output_substitution_disabled_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_owned_vouts(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_owned_vouts_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_psbt(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_psbt_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2PayjoinProposal_utxos_to_be_locked(
    port_: i64,
    that: *mut wire_cst_v_2_payjoin_proposal,
) {
    wire_V2PayjoinProposal_utxos_to_be_locked_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2ProvisionalProposal_contribute_non_witness_input(
    port_: i64,
    that: *mut wire_cst_v_2_provisional_proposal,
    tx: *mut wire_cst_list_prim_u_8_loose,
    outpoint: *mut wire_cst_out_point,
) {
    wire_V2ProvisionalProposal_contribute_non_witness_input_impl(port_, that, tx, outpoint)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2ProvisionalProposal_contribute_witness_input(
    port_: i64,
    that: *mut wire_cst_v_2_provisional_proposal,
    txo: *mut wire_cst_tx_out,
    outpoint: *mut wire_cst_out_point,
) {
    wire_V2ProvisionalProposal_contribute_witness_input_impl(port_, that, txo, outpoint)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2ProvisionalProposal_finalize_proposal(
    port_: i64,
    that: *mut wire_cst_v_2_provisional_proposal,
    process_psbt: *const std::ffi::c_void,
    min_feerate_sat_per_vb: *mut u64,
) {
    wire_V2ProvisionalProposal_finalize_proposal_impl(
        port_,
        that,
        process_psbt,
        min_feerate_sat_per_vb,
...
#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2ProvisionalProposal_substitute_output_address(
    port_: i64,
    that: *mut wire_cst_v_2_provisional_proposal,
    address: *mut wire_cst_list_prim_u_8_strict,
) {
    wire_V2ProvisionalProposal_substitute_output_address_impl(port_, that, address)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2ProvisionalProposal_try_preserving_privacy(
    port_: i64,
    that: *mut wire_cst_v_2_provisional_proposal,
    candidate_inputs: *mut wire_cst_list_record_u_64_out_point,
) {
    wire_V2ProvisionalProposal_try_preserving_privacy_impl(port_, that, candidate_inputs)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2UncheckedProposal_assume_interactive_receiver(
    port_: i64,
    that: *mut wire_cst_v_2_unchecked_proposal,
) {
    wire_V2UncheckedProposal_assume_interactive_receiver_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2UncheckedProposal_check_broadcast_suitability(
    port_: i64,
    that: *mut wire_cst_v_2_unchecked_proposal,
    min_fee_rate: *mut u64,
    can_broadcast: *const std::ffi::c_void,
...
#[no_mangle]
pub extern "C" fn frbgen_payjoin_flutter_wire_V2UncheckedProposal_extract_tx_to_schedule_broadcast(
    port_: i64,
    that: *mut wire_cst_v_2_unchecked_proposal,
) {
    wire_V2UncheckedProposal_extract_tx_to_schedule_broadcast_impl(port_, that)
}
...
pub extern "C" fn frbgen_payjoin_flutter_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockArcV2MaybeInputsOwned(
    ...
    unsafe {
        StdArc::<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < V2MaybeInputsOwned >>>::increment_strong_count(ptr as _);
    }
}
...
pub extern "C" fn frbgen_payjoin_flutter_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockArcV2MaybeInputsOwned(
    ...
    unsafe {
        StdArc::<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < V2MaybeInputsOwned >>>::decrement_strong_count(ptr as _);
    }
}
...
pub extern "C" fn frbgen_payjoin_flutter_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockArcV2MaybeInputsSeen(
    ...
    unsafe {
        StdArc::<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < V2MaybeInputsSeen >>>::increment_strong_count(ptr as _);
    }
}
...
pub extern "C" fn frbgen_payjoin_flutter_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockArcV2MaybeInputsSeen(
    ...
    unsafe {
        StdArc::<flutter_rust_bridge::for_generated::rust_async::RwLock<Arc < V2MaybeInputsSeen >>>::decrement_strong_count(ptr as _);
    }
}
...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct wire_cst_request_response {
    request: wire_cst_request,
    client_response: wire_cst_client_response,
}
#[repr(C)]
#[derive(Clone, Copy)]
